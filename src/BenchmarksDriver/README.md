...
Options:
  ...
  -rd|
  --replaceDescription   When used, the Excluded flag will be set on the previous records with the same Description.
  -rs|--replaceSession   When used, the Excluded flag will be set on the previous records with the same Session.
```
